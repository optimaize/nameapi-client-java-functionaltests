...
/**
 */
public class PT_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_PT_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Maria José Costa e Silva Mão de Ferro")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Maria José Costa e Silva")).build();
