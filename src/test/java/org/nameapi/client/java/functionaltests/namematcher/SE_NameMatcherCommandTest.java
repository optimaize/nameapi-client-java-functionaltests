...
/**
 */
public class SE_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_SE_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Maud Solveig Christina Wikström")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Fru M. Wikström")).build();
