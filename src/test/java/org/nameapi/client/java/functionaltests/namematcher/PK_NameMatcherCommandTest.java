...
/**
 */
public class PK_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_PK_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Hussain Qureshi")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("حسين قریشی")).build();
