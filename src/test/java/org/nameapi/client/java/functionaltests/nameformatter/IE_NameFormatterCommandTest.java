...
/**
 */
public class IE_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_IE_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("lIaM Ó MuRcHú")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Liam Ó Murchú");
    }
    ...
    public void test_IE_2() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("Tadhg mac cárthaigh")).build();
        FormatterProperties properties = new FormatterProperties(true);
        PersonNameFormatterArgument argument = new PersonNameFormatterArgument(person, properties);
        FormatterResult formatterResult = executor.execute(command, mode, argument).get();
        assertEquals(formatterResult.getFormatted(), "Tadhg Mac Cárthaigh");
    }
}
