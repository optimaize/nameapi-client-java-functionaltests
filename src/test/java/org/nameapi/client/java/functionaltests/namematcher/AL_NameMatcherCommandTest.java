...
/**
 */
public class AL_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_AL_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Altin Hoxha")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Zotëri A. Hoxha")).build();
