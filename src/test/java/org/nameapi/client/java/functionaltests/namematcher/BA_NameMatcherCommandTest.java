...
/**
 */
public class BA_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_BA_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Lamija Hadžić")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Lamija Hadzic")).build();
    ...
    public void test_BA_2() throws Exception {
        ...
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Lamija Hadžić")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Milica Hadzic")).build();
        PersonMatcherArgument argument = new PersonMatcherArgument(person1, person2);
        PersonMatcherResult result = executor.execute(command, mode, argument).get();
