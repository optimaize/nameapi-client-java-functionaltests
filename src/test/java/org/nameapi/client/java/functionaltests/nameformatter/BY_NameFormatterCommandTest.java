...
/**
 */
public class BY_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_BY_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("NIKITA IVANOŬ")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Nikita Ivanoŭ");
    }
    ...
    public void test_BY_2() throws Exception {
        ...
        PersonNameFormatterArgument argument = new PersonNameFormatterArgument(person, properties);
        FormatterResult formatterResult = executor.execute(command, mode, argument).get();
        assertEquals(formatterResult.getFormatted(), "Dmitry Aleksandrovich Koldun");
    }

    @Test
    public void test_BY_3() throws Exception {
        PersonNameFormatterCommand command = new PersonNameFormatterCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        ...
        PersonNameFormatterArgument argument = new PersonNameFormatterArgument(person, properties);
        FormatterResult formatterResult = executor.execute(command, mode, argument).get();
        assertEquals(formatterResult.getFormatted(), "Дзьмітры Аляксандравіч Калдун");
    }
}
