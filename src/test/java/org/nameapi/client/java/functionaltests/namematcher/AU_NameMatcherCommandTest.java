...
/**
 */
public class AU_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_AU_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Wayne Bentley Phillips")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Wayne B. Phillips")).build();
