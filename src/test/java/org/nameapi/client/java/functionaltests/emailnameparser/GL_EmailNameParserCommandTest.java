...
/**
 */
public class GL_EmailNameParserCommandTest {
    ...
    public void test_GL_1() throws Exception {
        ...
        EmailNameParserResult result = executor.execute(command, mode, "inunnguaq.berthelsen@example.gl").get();
    ...
    @Test
    public void test_GL_2() throws Exception {
        EmailNameParserCommand command = new EmailNameParserCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
