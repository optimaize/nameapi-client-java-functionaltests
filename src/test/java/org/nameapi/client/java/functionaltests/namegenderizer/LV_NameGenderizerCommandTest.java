...
/**
 */
public class LV_NameGenderizerCommandTest extends AbstractTest {
    ...
    public void test_LV_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("Artūrs Bērziņš")).build();
