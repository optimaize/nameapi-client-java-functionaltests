...
/**
 */
public class CY_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_CY_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("ανδρεας γεωργιου")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Ανδρεας Γεωργιου");
    }
    ...
    public void test_CY_2() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("aNdReAs gEoRgIoU")).build();
        FormatterProperties properties = new FormatterProperties(true);
        PersonNameFormatterArgument argument = new PersonNameFormatterArgument(person, properties);
        FormatterResult formatterResult = executor.execute(command, mode, argument).get();
        assertEquals(formatterResult.getFormatted(), "Andreas Georgiou");
    }
}
