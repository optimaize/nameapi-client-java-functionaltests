...
/**
 */
public class MM_NameFormatterCommandTest extends AbstractTest {
...
//    @Test
    public void test_MM_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("u thant nu aung")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "U Thant Nu Aung");
    }
}
