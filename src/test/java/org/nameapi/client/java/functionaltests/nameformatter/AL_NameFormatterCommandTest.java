...
/**
 */
public class AL_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_AL_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("alTin HOxHa")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Altin Hoxha");
    }
