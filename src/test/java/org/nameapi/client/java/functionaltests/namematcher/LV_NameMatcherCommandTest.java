...
/**
 */
public class LV_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_LV_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Artūrs Bērziņš")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("A. Bērziņš")).build();
