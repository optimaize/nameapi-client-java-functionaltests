...
/**
 */
public class CH_NameGenderizerCommandTest extends AbstractTest {
    ...
    public void test_CH_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("Annekäthi Auf der Maur")).build();
