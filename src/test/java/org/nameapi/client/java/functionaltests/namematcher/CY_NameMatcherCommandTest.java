...
/**
 */
public class CY_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_CY_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Lee Hai Dong")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("李海东")).build();
