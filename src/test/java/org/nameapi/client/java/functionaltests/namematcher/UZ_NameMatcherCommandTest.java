...
/**
 */
public class UZ_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_UZ_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Qobilova Fazilat Xurram qizi")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Qobilova Fazilat")).build();
