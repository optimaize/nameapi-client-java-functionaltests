...
/**
 */
public class AM_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_AM_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Anahit Hovhannisyan")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Անահիտ Հովհաննիսյան")).build();
    ...
    public void test_AM_2() throws Exception {
        ...
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Anahit Hovhannisyan")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Ա. Հովհաննիսյան")).build();
        PersonMatcherArgument argument = new PersonMatcherArgument(person1, person2);
        PersonMatcherResult result = executor.execute(command, mode, argument).get();
        assertEquals(result.getMatchType(), PersonMatchType.MATCHING);
    }
