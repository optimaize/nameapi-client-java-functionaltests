...
/**
 */
public class PL_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_PL_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Piotr Brożek")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Piotruś Brożek")).build();
