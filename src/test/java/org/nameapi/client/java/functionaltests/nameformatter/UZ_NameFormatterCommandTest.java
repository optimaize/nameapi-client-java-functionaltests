...
/**
 */
public class UZ_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_UZ_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("ikrom o'ktamovich nazarov")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Ikrom O'ktamovich Nazarov");
    }
