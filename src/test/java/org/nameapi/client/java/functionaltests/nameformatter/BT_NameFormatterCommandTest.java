...
/**
 */
public class BT_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_BT_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("Jigme tenzin")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Jigme Tenzin");
    }
    ...
    public void test_BT_2() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("dAsHo jIgMe tEnZiN")).build();
        FormatterProperties properties = new FormatterProperties(true);
        PersonNameFormatterArgument argument = new PersonNameFormatterArgument(person, properties);
        FormatterResult formatterResult = executor.execute(command, mode, argument).get();
        assertEquals(formatterResult.getFormatted(), "Dasho Jigme Tenzin");
    }
}
