...
/**
 */
public class NO_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_NO_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Aksel Hansen")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Herr A. Hansen")).build();
