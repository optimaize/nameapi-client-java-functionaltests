...
/**
 */
public class BA_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_BA_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("lAmIjA HaDžIć")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Lamija Hadžić");
    }
}
