...
/**
 */
public class TJ_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_TJ_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("firuza rustamzod")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Firuza Rustamzod");
    }
}
