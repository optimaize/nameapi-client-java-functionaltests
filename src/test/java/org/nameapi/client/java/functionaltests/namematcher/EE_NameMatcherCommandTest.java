...
/**
 */
public class EE_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_EE_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Eliise Tamm")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Proua E. Tamm")).build();
