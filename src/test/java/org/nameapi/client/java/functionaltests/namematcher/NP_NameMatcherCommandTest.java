...
/**
 */
public class NP_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_NP_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Janak Bishal Khatri-Chhetri")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Janak Bishal K.C.")).build();
