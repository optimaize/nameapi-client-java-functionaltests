...
/**
 */
public class AZ_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_AZ_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("İlyas Məhəmməd oğlu Əfəndiyev")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("İlyas Əfəndiyev")).build();
