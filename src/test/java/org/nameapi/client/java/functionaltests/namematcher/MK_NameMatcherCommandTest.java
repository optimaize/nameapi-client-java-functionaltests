...
/**
 */
public class MK_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_MK_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Dimo Todorovski")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Димо Тодоровски")).build();
