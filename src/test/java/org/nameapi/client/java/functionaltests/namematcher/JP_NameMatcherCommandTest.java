...
/**
 */
public class JP_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_JP_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Yamamoto Takeshi")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("やまもと たけし")).build();
    ...
    public void test_JP_2() throws Exception {
        ...
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Yamamoto Takeshi")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("ヤマモト タケシ")).build();
        PersonMatcherArgument argument = new PersonMatcherArgument(person1, person2);
        PersonMatcherResult result = executor.execute(command, mode, argument).get();
        assertEquals(result.getMatchType(), PersonMatchType.MATCHING);
    }
    ...
    @Test
    public void test_JP_3() throws Exception {
        PersonMatcherCommand command = new PersonMatcherCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("山元武")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("ヤマモト タケシ")).build();
        PersonMatcherArgument argument = new PersonMatcherArgument(person1, person2);
        PersonMatcherResult result = executor.execute(command, mode, argument).get();
        assertEquals(result.getMatchType(), PersonMatchType.MATCHING);
    ...
    @Test
    public void test_JP_4() throws Exception {
        PersonMatcherCommand command = new PersonMatcherCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("山元武")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("やまもと たけし")).build();
    ...
    @Test
    public void test_JP_5() throws Exception {
        PersonMatcherCommand command = new PersonMatcherCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Yamamoto Takeshi")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("山元武")).build();
        PersonMatcherArgument argument = new PersonMatcherArgument(person1, person2);
        PersonMatcherResult result = executor.execute(command, mode, argument).get();
        assertEquals(result.getMatchType(), PersonMatchType.MATCHING);
    }
