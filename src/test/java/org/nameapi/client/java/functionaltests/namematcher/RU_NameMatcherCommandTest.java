...
/**
 */
public class RU_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_RU_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Lev Nikolayevich Tolstoy")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Count Lev Tolstoy")).build();
