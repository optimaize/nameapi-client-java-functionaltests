...
/**
 */
public class IS_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_IS_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("FREYJA JÓNSDÓTTIR")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Freyja Jónsdóttir");
    }
