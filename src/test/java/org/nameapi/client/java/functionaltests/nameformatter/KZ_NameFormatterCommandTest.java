...
/**
 */
public class KZ_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_KZ_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("еРаСыЛ НуРтАеВиЧ КаЛиЕв")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Ерасыл Нуртаевич Калиев");
    }
    ...
    public void test_KZ_2() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("YERASYL NURTAYEVICH KALIEV")).build();
        FormatterProperties properties = new FormatterProperties(true);
        PersonNameFormatterArgument argument = new PersonNameFormatterArgument(person, properties);
        FormatterResult formatterResult = executor.execute(command, mode, argument).get();
        assertEquals(formatterResult.getFormatted(), "Yerasyl Nurtayevich Kaliev");
    }

    @Test
    public void test_KZ_3() throws Exception {
        PersonNameFormatterCommand command = new PersonNameFormatterCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
    ...
    @Test
    public void test_KZ_4() throws Exception {
        PersonNameFormatterCommand command = new PersonNameFormatterCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
