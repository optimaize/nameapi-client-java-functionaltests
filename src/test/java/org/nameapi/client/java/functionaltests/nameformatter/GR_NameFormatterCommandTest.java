...
/**
 */
public class GR_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_GR_1() throws Exception {
        ...
        assertEquals(formatterResult.getFormatted(), "Στυλιανος Αλέξανδρος Παπαδόπουλος");
    }
    ...
    public void test_GR_2() throws Exception {
        ...
        PersonNameFormatterArgument argument = new PersonNameFormatterArgument(person, properties);
        FormatterResult formatterResult = executor.execute(command, mode, argument).get();
        assertEquals(formatterResult.getFormatted(), "Stylianos Alexandros Papadopoulos");
    }
    ...
    public void test_GR_3() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("σΤυΛιΑνΟς αΛέΞαΝδΡοΣ ΠαΠαΔόΠοΥλΟς")).build();
        FormatterProperties properties = new FormatterProperties(true);
        PersonNameFormatterArgument argument = new PersonNameFormatterArgument(person, properties);
        FormatterResult formatterResult = executor.execute(command, mode, argument).get();
        assertEquals(formatterResult.getFormatted(), "Στυλιανος Αλέξανδροσ Παπαδόπουλος");
    }

    @Test
    public void test_GR_4() throws Exception {
        PersonNameFormatterCommand command = new PersonNameFormatterCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
