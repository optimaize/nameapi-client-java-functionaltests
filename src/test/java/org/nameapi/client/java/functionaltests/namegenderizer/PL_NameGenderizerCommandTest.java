...
/**
 */
public class PL_NameGenderizerCommandTest extends AbstractTest {
    ...
    public void test_PL_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("Piotr Brożek")).build();
