...
/**
 */
public class KZ_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_KZ_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Ерасыл Нуртаевич Калиев")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Ерасыл Калиев")).build();
    ...
    public void test_KZ_2() throws Exception {
        PersonMatcherCommand command = new PersonMatcherCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Yerasyl Nurtayevich Kaliev")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Yerasyl Kaliev")).build();
        PersonMatcherArgument argument = new PersonMatcherArgument(person1, person2);
        PersonMatcherResult result = executor.execute(command, mode, argument).get();
        assertEquals(result.getMatchType(), PersonMatchType.MATCHING);
    }
