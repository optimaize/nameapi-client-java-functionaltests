...
/**
 */
public class VN_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_VN_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Nguyễn Quang Dũng")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Quang Dung Nguyen")).build();
