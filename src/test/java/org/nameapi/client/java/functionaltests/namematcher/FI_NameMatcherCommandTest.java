...
/**
 */
public class FI_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_FI_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Väinö Johansson")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Harra V. Johansson")).build();
