...
/**
 */
public class IL_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_IL_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("NOAM LEVI")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Noam Levi");
    }
