...
/**
 */
public class LA_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_LA_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Khampha Keomuongchanh")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Th. Khampha Keomuongchanh")).build();
