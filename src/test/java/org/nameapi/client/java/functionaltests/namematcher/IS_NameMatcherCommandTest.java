...
/**
 */
public class IS_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_IS_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Freyja Jónsdóttir")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Frú F. Jónsdóttir")).build();
