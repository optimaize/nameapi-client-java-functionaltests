...
/**
 */
public class PK_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_PK_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("hUsSaIn qUrEsHi")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Hussain Qureshi");
    }
}
