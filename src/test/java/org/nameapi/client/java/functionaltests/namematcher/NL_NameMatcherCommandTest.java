...
/**
 */
public class NL_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_NL_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Peter van der Sar")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Heer P. van der Sar")).build();
