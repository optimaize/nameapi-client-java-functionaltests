...
/**
 */
public class FR_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_FR_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("JEAN-CLAUDE LAFORGE")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Jean-Claude Laforge");
    }
