...
/**
 */
public class FR_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_FR_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Jean-Claude Laforge")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Monsieur Jean-Claude Laforge")).build();
