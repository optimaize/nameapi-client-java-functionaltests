...
/**
 */
public class BE_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_BE_1() throws Exception {
        ...
        assertEquals(formatterResult.getFormatted(), "Gaston Cyriel Durnez");
    }
    ...
    public void test_BE_2() throws Exception {
        ...
        PersonNameFormatterArgument argument = new PersonNameFormatterArgument(person, properties);
        FormatterResult formatterResult = executor.execute(command, mode, argument).get();
        assertEquals(formatterResult.getFormatted(), "Jan Theodoor van Rijswijck");
    }
    ...
    public void test_BE_3() throws Exception {
        ...
        PersonNameFormatterArgument argument = new PersonNameFormatterArgument(person, properties);
        FormatterResult formatterResult = executor.execute(command, mode, argument).get();
        assertEquals(formatterResult.getFormatted(), "François Weyergans");
    }
}
