...
/**
 */
public class AZ_NameGenderizerCommandTest extends AbstractTest {
    ...
    public void test_AZ_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("İlyas Məhəmməd oğlu Əfəndiyev")).build();
