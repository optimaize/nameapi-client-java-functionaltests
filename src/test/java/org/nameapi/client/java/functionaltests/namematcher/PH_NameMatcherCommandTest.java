...
/**
 */
public class PH_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_PH_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("John Paul Mercado Reyes")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("John Paul Reyes")).build();
