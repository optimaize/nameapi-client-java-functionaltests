...
/**
 */
public class SI_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_SI_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("ŽIGA KOVAČIČ")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Žiga Kovačič");
    }
}
