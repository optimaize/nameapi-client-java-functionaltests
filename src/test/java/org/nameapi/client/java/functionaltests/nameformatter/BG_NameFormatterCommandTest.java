...
/**
 */
public class BG_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_BG_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("nikol georgieva dimitrova")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Nikol Georgieva Dimitrova");
    }
}
