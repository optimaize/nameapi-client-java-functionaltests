...
/**
 */
public class LA_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_LA_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("khampha keomuongchanh")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Khampha Keomuongchanh");
    }
}
