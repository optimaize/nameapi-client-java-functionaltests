...
/**
 */
public class JP_EmailNameParserCommandTest {
    ...
    public void test_JP_1() throws Exception {
        ...
        EmailNameParserResult result = executor.execute(command, mode, "takeshi.yamamoto@example.jp").get();
        assertEquals(result.getResultType(), EmailAddressParsingResultType.PERSON_NAME);
        assertEquals(result.getBestNameMatch().get().getGivenNames().get(0).getName(), "takeshi");
        assertEquals(result.getBestNameMatch().get().getSurnames().get(0).getName(), "yamamoto");
    }
    ...
    public void test_JP_2() throws Exception {
        EmailNameParserCommand command = new EmailNameParserCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        EmailNameParserResult result = executor.execute(command, mode, "takeshiyamamoto@example.jp").get();
        assertEquals(result.getResultType(), EmailAddressParsingResultType.PERSON_NAME);
        assertEquals(result.getBestNameMatch().get().getGivenNames().get(0).getName(), "takeshi");
        assertEquals(result.getBestNameMatch().get().getSurnames().get(0).getName(), "yamamoto");
    }
    ...
    public void test_JP_3() throws Exception {
        EmailNameParserCommand command = new EmailNameParserCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        EmailNameParserResult result = executor.execute(command, mode, "yamamototakeshi@example.jp").get();
        assertEquals(result.getResultType(), EmailAddressParsingResultType.PERSON_NAME);
        assertEquals(result.getBestNameMatch().get().getGivenNames().get(0).getName(), "takeshi");
        assertEquals(result.getBestNameMatch().get().getSurnames().get(0).getName(), "yamamoto");
    }
