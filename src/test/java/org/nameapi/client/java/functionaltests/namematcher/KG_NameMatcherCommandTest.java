...
/**
 */
public class KG_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_KG_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Marat Zhanybek uulu")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("M. Zhanybek uulu")).build();
