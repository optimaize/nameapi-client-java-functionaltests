...
/**
 */
public class GL_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_GL_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("INUNNGUAQ BERTHELSEN")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Inunnguaq Berthelsen");
    }
}
