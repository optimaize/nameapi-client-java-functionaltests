...
/**
 */
public class DE_EmailNameParserCommandTest {
    ...
    public void test_DE_1() throws Exception {
        ...
        EmailNameParserResult result = executor.execute(command, mode, "daniela.meyer@example.de").get();
        assertEquals(result.getResultType(), EmailAddressParsingResultType.PERSON_NAME);
        assertEquals(result.getBestNameMatch().get().getGivenNames().get(0).getName(), "daniela");
        assertEquals(result.getBestNameMatch().get().getSurnames().get(0).getName(), "meyer");
    }
    ...
    public void test_DE_2() throws Exception {
        EmailNameParserCommand command = new EmailNameParserCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        EmailNameParserResult result = executor.execute(command, mode, "danielameyer@example.de").get();
        assertEquals(result.getResultType(), EmailAddressParsingResultType.PERSON_NAME);
        assertEquals(result.getBestNameMatch().get().getGivenNames().get(0).getName(), "daniela");
        assertEquals(result.getBestNameMatch().get().getSurnames().get(0).getName(), "meyer");
    }
    ...
    public void test_DE_3() throws Exception {
        EmailNameParserCommand command = new EmailNameParserCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        EmailNameParserResult result = executor.execute(command, mode, "meyerdaniela@example.de").get();
        assertEquals(result.getResultType(), EmailAddressParsingResultType.PERSON_NAME);
        assertEquals(result.getBestNameMatch().get().getGivenNames().get(0).getName(), "daniela");
        assertEquals(result.getBestNameMatch().get().getSurnames().get(0).getName(), "meyer");
    }
