...
/**
 */
public class IL_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_IL_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("נועם לֵוִי")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Noam Levi")).build();
