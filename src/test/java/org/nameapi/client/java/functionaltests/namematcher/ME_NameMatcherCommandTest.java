...
/**
 */
public class ME_NameMatcherCommandTest extends AbstractTest {
...
//    @Test
    public void test_ME_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Milica Medojević")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Milijana Medojević")).build();
