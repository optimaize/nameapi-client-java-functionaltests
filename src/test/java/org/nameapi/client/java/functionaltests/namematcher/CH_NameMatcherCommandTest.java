...
/**
 */
public class CH_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_CH_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Annekäthi Auf der Maur")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Frau A. Auf der Maur")).build();
