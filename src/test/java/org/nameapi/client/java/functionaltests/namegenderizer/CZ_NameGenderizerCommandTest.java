...
/**
 */
public class CZ_NameGenderizerCommandTest extends AbstractTest {
    ...
    public void test_CZ_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("Kristýna Nováková")).build();
