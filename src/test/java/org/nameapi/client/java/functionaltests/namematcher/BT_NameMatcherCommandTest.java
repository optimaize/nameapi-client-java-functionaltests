...
/**
 */
public class BT_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_BT_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Jigme Tenzin")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Dasho Jigme Tenzin")).build();
