...
/**
 */
public class NL_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_NL_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("PEtER VaN DeR SaR")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Peter van der Sar");
    }
