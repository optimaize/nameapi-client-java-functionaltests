...
/**
 */
public class IT_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_IS_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Marcello Vincenzo Domenico Mastroianni")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Signore Marcello Mastroianni")).build();
