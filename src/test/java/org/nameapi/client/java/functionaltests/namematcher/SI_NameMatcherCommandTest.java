...
/**
 */
public class SI_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_SI_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Žiga Kovačič")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Z. Kovacic")).build();
