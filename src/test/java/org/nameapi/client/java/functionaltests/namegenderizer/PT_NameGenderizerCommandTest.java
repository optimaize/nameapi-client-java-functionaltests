...
/**
 */
public class PT_NameGenderizerCommandTest extends AbstractTest {
    ...
    public void test_PT_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("José Eduardo dos Santos")).build();
