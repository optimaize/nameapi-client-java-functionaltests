...
/**
 */
public class GB_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_GB_1() throws Exception {
        ...
        assertEquals(formatterResult.getFormatted(), "Ethan O'Neil");
    }
    ...
    public void test_GB_2() throws Exception {
        ...
        PersonNameFormatterArgument argument = new PersonNameFormatterArgument(person, properties);
        FormatterResult formatterResult = executor.execute(command, mode, argument).get();
        assertEquals(formatterResult.getFormatted(), "Ethan Daniel O'Neil");
    }
}
