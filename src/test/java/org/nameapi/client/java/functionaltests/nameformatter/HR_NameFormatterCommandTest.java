...
/**
 */
public class HR_NameFormatterCommandTest extends AbstractTest {
    ...
    public void test_HR_1() throws Exception {
        ...
        NaturalInputPerson person = new NaturalInputPersonBuilder().name(makeName("MARKO HORVAT")).build();
        ...
        assertEquals(formatterResult.getFormatted(), "Marko Horvat");
    }
}
