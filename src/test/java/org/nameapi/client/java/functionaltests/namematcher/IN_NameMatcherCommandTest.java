...
/**
 */
public class IN_NameMatcherCommandTest extends AbstractTest {
    ...
    public void test_IN_1() throws Exception {
        ...
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Suresh Patel")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("Suresh Kumar Patel")).build();
    ...
    public void test_IN_2() throws Exception {
        ...
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("Suresh Patel")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("षुरेश् पटेल")).build();
        PersonMatcherArgument argument = new PersonMatcherArgument(person1, person2);
        PersonMatcherResult result = executor.execute(command, mode, argument).get();
        assertEquals(result.getMatchType(), PersonMatchType.MATCHING);
    }
    ...
    public void test_IN_3() throws Exception {
        PersonMatcherCommand command = new PersonMatcherCommand();
        Mode mode = FunctionalTestsNameApiModeFactory.functionalTest();
        NaturalInputPerson person1 = new NaturalInputPersonBuilder().name(makeName("षुरेश् पटेल")).build();
        NaturalInputPerson person2 = new NaturalInputPersonBuilder().name(makeName("षुरेश् ख़ुमर् पटेल")).build();
        PersonMatcherArgument argument = new PersonMatcherArgument(person1, person2);
        PersonMatcherResult result = executor.execute(command, mode, argument).get();
        assertEquals(result.getMatchType(), PersonMatchType.MATCHING);
    }
